void main(){
  ...
  print('Nuclear: ${ chargePhone(nuclearPlant)}'); //usando un método con la herencia 
}
...
abstract class EnergyPlant {
  ...
  final PlantType type; //Usamos la enum para tener solo de cierto tipo.
...
//Puede implementar sólo un método en particular y no todo
class NuclearPlant implements EnergyPlant{
  ...
  @override
  void consumeEnergy( double amount ){
    energyLeft -= (amount*0.5); //suponiendoque es mas eficiente
  }
}